            ...
            <ShowInfo wrapMode>
                <ShowInfo.Content>
                    ...
                    >
                        ...
                        <p
                            className={`text-base font-normal text-neutral-700 dark:text-neutral-300 cursor-pointer ${skill.unlike
                ...
                <ShowInfo.Description className="text-left prose dark:prose-invert prose-sm max-w-none">
                    ...
                    {((skill.hours !== undefined && skill.hours > 0) || (skill.minutes !== undefined && skill.minutes > 0)) && (
                        <p className="mt-2 text-xs text-neutral-500">
                            {skill.hours && skill.hours > 0 ? `${skill.hours}h` : ''}
                            {skill.hours && skill.hours > 0 && skill.minutes && skill.minutes > 0 ? '' : ''}
                            {skill.minutes && skill.minutes > 0 ? `${skill.minutes}m` : ''} of usage in 2025
                        </p>
                    )}
                </ShowInfo.Description>
            </ShowInfo>
