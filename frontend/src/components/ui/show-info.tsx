    ...
    (
        ...
        const handleClick = () => {
            if (isMobile && !disableToast) {
                ...
                const descriptionContent = wrapMode
                    ? (
                        React.Children.toArray(children).find(
                            (child): child is React.ReactElement<ShowInfoChildProps> =>
                ...
                toast({
                    title: typeof titleContent === 'string' ? decodeHtmlEntities(titleContent) : titleContent?.toString() ?? "",
                    description: typeof descriptionContent === 'string' ? decodeHtmlEntities(descriptionContent) : descriptionContent,
                });
            }
        };
