...
const toastVariants = cva(
    "group pointer-events-auto relative flex w-full items-center justify-between space-x-4 overflow-hidden rounded-md max-sm:border p-6 pr-8 shadow-lg sm:max-w-[420px]",
    {
        variants: {
            variant: {
                default:
