...
export function PhoneInput({
	...
	const initializeDefaultValue = () => {
		...
		return selectedCountry ? `+${selectedCountry.phone_code}` : "";
	};
	...
	return (
		<div className={cn("flex gap-2", className)}>
			<Popover open={openCommand} onOpenChange={setOpenCommand} modal={true}>
				<PopoverTrigger asChild>
					<Button
						...
						className="w-max items-center justify-between whitespace-nowrap bg-neutral-100 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 border-neutral-200 dark:border-neutral-800"
					>
						{isLoading ? (
							"Loading..."
						) : selectedCountry ? (
				...
				<PopoverContent
					className="p-0 w-max bg-neutral-100 dark:bg-neutral-900"
					align="start"
				>
					<Command className="bg-neutral-100 dark:bg-neutral-900">
						<CommandInput
								...
								<CommandGroup>
									{countries.map((country) => (
										<CommandItem
											...
											className="text-neutral-900 dark:text-neutral-100 hover:bg-neutral-200 dark:hover:bg-neutral-800"
										>
											<Check
												className={cn(
													"mr-2 size-4",
			...
			<Input
				...
				name="phone"
				id={id}
				placeholder={isLoading ? "Loading..." : "Phone"}
				...
				className="bg-neutral-100 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 border-neutral-200 dark:border-neutral-800"
				disabled={isLoading}
				{...rest}
			/>
		</div>
