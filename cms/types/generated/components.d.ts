...
export interface SharedEducationSection extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        platforms: Schema.Attribute.Component<"shared.education-platform", true> & Schema.Attribute.Required;
...
export interface SharedExpertise extends Struct.ComponentSchema {
    ...
    attributes: {
        description: Schema.Attribute.String & Schema.Attribute.Required;
        icon: Schema.Attribute.Enumeration<["Code", "Server", "Palette", "Layers", "Cog"]> & Schema.Attribute.Required;
...
export interface SharedLanguagesSection extends Struct.ComponentSchema {
    ...
    attributes: {
        description: Schema.Attribute.String & Schema.Attribute.Required;
        languages: Schema.Attribute.Component<"shared.language", true> & Schema.Attribute.Required;
        title: Schema.Attribute.String & Schema.Attribute.Required;
    };
}
...
export interface SharedMethodology extends Struct.ComponentSchema {
    ...
    attributes: {
        description: Schema.Attribute.String & Schema.Attribute.Required;
        icon: Schema.Attribute.Enumeration<["GitBranch", "Building", "Cog", "GitPullRequest", "Users", "TestTube", "Smartphone", "Server"]> &
...
export interface SharedSocialLink extends Struct.ComponentSchema {
    ...
    attributes: {
        ...
        iconType: Schema.Attribute.Enumeration<["Github", "Linkedin", "Youtube", "Twitter"]> & Schema.Attribute.Required;
        target: Schema.Attribute.Enumeration<["_blank", "_self"]> & Schema.Attribute.Required & Schema.Attribute.DefaultTo<"_blank">;
        title: Schema.Attribute.String & Schema.Attribute.Required;
    };
}
...
export interface SharedSoftSkill extends Struct.ComponentSchema {
    ...
    attributes: {
        description: Schema.Attribute.String & Schema.Attribute.Required;
        icon: Schema.Attribute.Enumeration<["MessageSquare", "Users", "Lightbulb", "RefreshCw", "BookOpen", "Timer", "Crosshair", "Sparkles"]> &
            Schema.Attribute.Required;
        title: Schema.Attribute.String & Schema.Attribute.Required;
    };
}
