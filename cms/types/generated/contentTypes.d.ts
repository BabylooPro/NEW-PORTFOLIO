...
export interface ApiAboutSectionAboutSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    education: Schema.Attribute.Component<'shared.education-section', false> &
      Schema.Attribute.Required;
    languages: Schema.Attribute.Component<'shared.languages-section', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    personalInfo: Schema.Attribute.Component<'shared.personal-info', false> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiDevelopmentMethodologiesSectionDevelopmentMethodologiesSection
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::development-methodologies-section.development-methodologies-section'
    > &
      Schema.Attribute.Private;
    methodologies: Schema.Attribute.Component<'shared.methodology', true> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    titleDescription: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiExperienceSectionExperienceSection
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::experience-section.experience-section'
    > &
      Schema.Attribute.Private;
...
export interface ApiExpertiseSectionExpertiseSection
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    expertises: Schema.Attribute.Component<'shared.expertise', true> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiHeaderSectionHeaderSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    profile: Schema.Attribute.Component<'shared.profile-description', false> &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHeroSectionHeroSection extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    swissArmyKnifeDescription: Schema.Attribute.String &
      Schema.Attribute.Required;
...
export interface ApiProjectsSectionProjectsSection
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::projects-section.projects-section'
    > &
      Schema.Attribute.Private;
...
export interface ApiSkillSkill extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    skillYear: Schema.Attribute.Relation<
      'manyToOne',
      'api::skill-year.skill-year'
    >;
...
export interface ApiSoftSkillsSectionSoftSkillsSection
  extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::soft-skills-section.soft-skills-section'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    softSkills: Schema.Attribute.Component<'shared.soft-skill', true> &
      Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    titleDescription: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiWhatIDoSectionWhatIDoSection
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::what-i-do-section.what-i-do-section'
    > &
      Schema.Attribute.Private;
    paragraphDescription: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
